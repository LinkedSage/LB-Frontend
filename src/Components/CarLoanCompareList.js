...
import CarLoanCompareListDetails from './CarLoanCompareListDetails';
import './CSS/CompareList.css';

export default function CarLoanCompareList({ compareList, removeCompareList, removeCompareItem }) {
    ...
    return (
        <>
            ...
            </div>
            {
                ...
                <CarLoanCompareListDetails handleCloseCompareListDetails={handleCloseCompareListDetails} compareList={compareList} />
            }
