...
import HomeLoanCompareListDetails from './HomeLoanCompareListDetails';

export default function HomeLoanCompareList({ compareList, removeCompareList, removeCompareItem }) {
    ...
    return (
        <>
            ...
            </div>
            {
                ...
                <HomeLoanCompareListDetails handleCloseCompareListDetails={handleCloseCompareListDetails} compareList={compareList} />
            }
