...
const HomeLoanCompareListDetails = ({ handleCloseCompareListDetails, compareList }) => {
                                                ...
                                                <div className='col details px-0'>
                                                    <div className='h-100'>
                                                        ...
                                                        <Link
                                                            ...
                                                            to={{
                                                                pathname: `/home-loan-application/${item._id}`,
                                                                state: { item },
                                                            }}
                                                        >
                                                            Apply Now
...
export default HomeLoanCompareListDetails;