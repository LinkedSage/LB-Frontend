        ...
        <div className="row d-flex align-items-center justify-content-center flex-column">
          ...
          <form className="sign-in-form" >
            <div className="input-field">
              ...
              <input type="number" id="otp" name="otp" placeholder="Enter the response" pattern="[0-9]{11}" onChange={(e) => { setOTP(e.target.value) }} required />
            </div>

            <input type="button" value="Verify" className="btn solid" onClick={submitOTPForm} />
