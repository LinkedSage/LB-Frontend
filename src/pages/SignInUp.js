...
export default function SignInUp() {
  ...
  useEffect(() => {
    ...
    if (document.getElementById("phoneSI"))
      document.getElementById("phoneSI").value = "";
    if (document.getElementById("emailSI"))
      document.getElementById("emailSI").value = "";
  ...
  function submitSigupForm(event) {
    event.preventDefault();
          ...
          <div className="panels-container">
            <div className="panel left-panel">
              <div className="content">
                <h3>New here ?</h3>
                <p>If don't have any account, please sign up.</p>
            ...
            <div className="panel right-panel">
              <div className="content">
                <h3>One of us ?</h3>
                <p>Already have an account, Please singin.</p>
